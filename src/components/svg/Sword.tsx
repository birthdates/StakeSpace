export default function Sword() {
    return <svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="swords" role="img"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                className="text-6xl mr-4 svg-inline--fa fa-swords fa-w-16 grey100--text">
